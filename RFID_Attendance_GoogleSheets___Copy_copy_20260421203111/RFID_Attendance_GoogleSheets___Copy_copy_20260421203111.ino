...
const String sheet_url = "https://script.google.com/macros/s/AKfycbzoex8T2HDkaMnu3kfz4WC2tCHpBelS8a5xRBNGsoNQ7UqvCvtZH4mdpk__IE1jgklI/exec?name=";  //Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "Rfid"  //Enter WiFi Name
#define WIFI_PASSWORD "nlbi7410"  //Enter WiFi Password
//-----------------------------------------
